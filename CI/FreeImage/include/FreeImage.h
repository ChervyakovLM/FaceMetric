...
DLL_API BYTE *DLL_CALLCONV FreeImage_GetScanLine_noalignment(FIBITMAP *dib, int scanline);
...
DLL_API unsigned DLL_CALLCONV FreeImage_GetPitch_noalignment(FIBITMAP *dib);
...
DLL_API BOOL DLL_CALLCONV FreeImage_FlipVertical_noalignment(FIBITMAP *dib);
